        ...
        return ConfigCategory.createBuilder().name(literal("Mining"))
                             ...
                             .group(OptionGroup.createBuilder()
                                               ...
                                               .option(Option.<Boolean>createBuilder()
                                                             ...
                                                             .build())
                                               .option(Option.<Boolean>createBuilder()
                                                             .name(literal("Tracker only in Crystal Hollows"))
                                                             .description(OptionDescription.of(literal("Only show the scatha tracker while in the Crystal Hollows.")))
                                                             .binding(defaults.mining.showOnlyInCrystalHollows,
                                                                     () -> config.mining.showOnlyInCrystalHollows,
                                                                     newValue -> config.mining.showOnlyInCrystalHollows = newValue)
                                                             .controller((opt) -> BooleanControllerBuilder.create(opt)
                                                                                                          .yesNoFormatter()
                                                                                                          .coloured(true))
                                                             .build())
